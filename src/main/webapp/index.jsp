...
<head>
    ...
    <!-- ------------------ Title ------------------ -->
    <title>Disney+ Hotstar - Watch TV-1 Shows Online</title>
        ...
        <div class="carousel">
            <!-- <div class="slider">
                <div class="slide-content">
                    ...
                    <p class="movie-des">Lorem Lalala title, sit amet consectetur adipisicing elit. Quam distinctio molestiae quis praesentium cum obcaecati eveniet voluptates exercitationem eum accusantium.</p>
                </div>
